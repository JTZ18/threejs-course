...
// notes lights cost alot of performances. dont add too much light
// option to bake the light into the textures
// light helpers help to position lights
...
rectAreaLight.lookAt(new THREE.Vector3()) // a vector3 is an invisible point at (0,0,0)
